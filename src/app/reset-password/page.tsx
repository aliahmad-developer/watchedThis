    ...
    <PageWrapper>
      <div className="w-full max-w-sm sm:max-w-md">
        ...
        <div className="mb-4 sm:mb-5 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg sm:text-xl font-semibold text-light-header dark:text-dark-header">
        ...
        {/* Card */}
        <div className="bg-light-card dark:bg-dark-card shadow-lg rounded-xl p-4 sm:p-5 w-full space-y-4">
          {/* PASSWORD */}
          <div>
