      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-light-card dark:bg-dark-card rounded-2xl shadow-md p-6 sm:p-10 relative overflow-hidden">
          ...
          <p className="text-light-body-text dark:text-dark-body-text leading-relaxed mb-10 text-sm sm:text-base">
            ...
            WatchedThis. This page shares our story, motivation, and vision.
          </p>
          ...
          <div className="space-y-6">
            <Section icon={faUsers} title="1. Who we are">
              ...
              (Slacker). Two developers passionate about movies and coding.
              We're not a company, just friends building fun tools.
            </Section>

            <Section icon={faFilm} title="2. Our story">
              Movie nights always stuck on choosing. We created WatchedThis for
              random discovery. No ads, no tracking, just fun. Built with coffee
              and passion.
            </Section>

            <Section icon={faHeart} title="3. Our philosophy">
              No ads, no data selling, no endless scrolls. We made WatchedThis
            ...
            <Section icon={faShuffle} title="4. How to support">
              ...
              covers Missy's design tools, Tiba's servers, and coffee. Helps us
              stay independent — no VCs, just indie creators.
            </Section>
          ...
          <div className="border-t border-light-border dark:border-dark-border mt-10 pt-6">
            <p className="text-center text-light-secondary-text dark:text-dark-secondary-text text-xs">
              Thanks for using WatchedThis. Made with{" "}
              <FontAwesomeIcon color="#D4AF37" icon={faHeart} /> by{" "}
              <span className="inline text-light-accent dark:text-dark-accent font-semibold">
                Missy & Tiba
              </span>
              .
  ...
  return (
    <div className="group">
      <div className="flex items-center gap-3 mb-2">
        <FontAwesomeIcon
          icon={icon}
          className="w-4 h-4 shrink-0 text-light-accent dark:text-dark-accent transition-transform duration-300 group-hover:scale-110"
        />
