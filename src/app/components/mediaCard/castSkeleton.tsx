  ...
  return (
    ...
    >
      ...
      <div className="mt-2 w-full">
        <div className="h-4 bg-light-border dark:bg-dark-border rounded w-20 mx-auto mb-1"></div>
        <div className="h-3 bg-light-border dark:bg-dark-border rounded w-16 mx-auto"></div>
      </div>

      {/* Role Skeleton */}
      <div className="mt-0.5 w-full">
        <div className="h-3 bg-light-border dark:bg-dark-border rounded w-24 mx-auto mb-1"></div>
        <div className="h-3 bg-light-border dark:bg-dark-border rounded w-20 mx-auto"></div>
      </div>

      {/* Episodes Skeleton (for TV shows) */}
      <div className="mt-0.5 w-full">
        <div className="h-3 bg-light-border dark:bg-dark-border rounded w-12 mx-auto"></div>
      </div>
    </div>
  );
}