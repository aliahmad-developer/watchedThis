      ...
      <div className="space-y-4 lg:space-y-5 max-w-xl">
        ...
        <div className="flex flex-wrap gap-3 pt-2">
          <button
            ...
            className="px-4 py-2 text-base rounded-full font-medium flex items-center gap-2 transition bg-light-btn-bg hover:bg-light-btn-bg-hover text-light-btn-text dark:bg-dark-btn-bg dark:hover:bg-dark-btn-bg-hover dark:text-dark-btn-text"
          >
