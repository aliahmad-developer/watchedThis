  ...
  useEffect(() => {
    checkRedirectResult().then((result) => {
      if (result.success && result.user) {
        ...
        // ignore — not a real error if no redirect was pending
      }
    });
  }, []);
    ...
    <>
      ...
      <div
        className={[
          ...
          "sm:rounded-xl sm:w-full sm:max-w-md",
          "overflow-y-auto max-h-[90dvh] sm:max-h-[90vh]",
          "px-4 pt-3 pb-6 sm:p-6",
          "transition-transform duration-300",
          isOpen ? "translate-y-0" : "translate-y-full sm:translate-y-[-40%] sm:opacity-0",
        ].join(" ")}
      >
        ...
        {/* Inner content — constrained width on wide mobile screens */}
